      ...
      <header class="site-header">
        <div class="logo">
          <span class="logo-mark" aria-hidden="true">
            <BrainCircuit class="logo-icon" :size="24" :stroke-width="1.8" />
          </span>
      ...
      <main class="hero-section">
        ...
        <div class="hero-content">
          <p class="hero-eyebrow reveal-up">
            <span class="eyebrow-dot"></span>知识连接 · 智能问答 · 任务协同
          </p>
...
.logo {
  ...
  .logo-mark {
    ...
    height: 34px;
    margin-right: 0.6rem;
    border: 1px solid color-mix(in srgb, var(--main-500) 34%, transparent);
    border-radius: 10px;
    background:
      radial-gradient(circle at 72% 22%, rgba(104, 214, 255, 0.34), transparent 38%),
      linear-gradient(145deg, var(--main-800), var(--main-600));
    color: white;
    box-shadow:
      0 8px 20px rgba(5, 98, 122, 0.18),
  ...
  .logo-mark::after {
    ...
    border-radius: 50%;
    background: #75e6ff;
    box-shadow: 0 0 8px rgba(117, 230, 255, 0.9);
    content: '';
  }
}
